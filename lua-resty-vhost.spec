...
Version:        0.1
Release:        3%{?dist}
Summary:        Hostname matching library for nginx-module-lua
Group:          Development/Libraries
License:        BSD
URL:            https://github.com/hamishforbes/lua-resty-vhost
...
Summary:        Hostname matching library for nginx-module-lua for Lua %{luacompatver}
