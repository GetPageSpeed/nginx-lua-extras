...
Version:        0.9
Release:        3%{?dist}
Summary:        Simple nonblocking lock API for nginx-module-lua based on shared memory dictionaries
...
Summary:        Simple nonblocking lock API for nginx-module-lua based on shared memory dictionaries for Lua %{luacompatver}
