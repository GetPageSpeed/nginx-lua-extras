...
Version:        1.0
Release:        4%{?dist}
Summary:        The HTTP/2 Protocol (Client Side) Implementation for nginx-module-lua
Group:          Development/Libraries
License:        BSD
URL:            https://github.com/tokers/lua-resty-http2
...
Summary:        The HTTP/2 Protocol (Client Side) Implementation for nginx-module-lua for Lua %{luacompatver}
