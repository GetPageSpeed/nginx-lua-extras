...
License:        BSD
URL:            https://github.com/jprjr/lua-resty-exec
...
Summary:        Run external programs in nginx-module-lua without spawning a shell or blocking for Lua %{luacompatver}
