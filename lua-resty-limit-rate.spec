...
%global luapkgname resty-limit-rate
...
Summary:        Lua module for limiting request rate for nginx-module-lua, using the "token bucket" method for Lua %{luacompatver}
