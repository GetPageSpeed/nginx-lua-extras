...
License:        BSD
URL:            https://github.com/pintsized/lua-resty-rack
...
Summary:        A simple and extensible HTTP server framework for nginx-module-lua for Lua %{luacompatver}
