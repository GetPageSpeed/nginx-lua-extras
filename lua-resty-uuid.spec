...
License:        BSD
URL:            https://github.com/bungle/lua-resty-uuid
...
Summary:        LuaJIT FFI bindings for libuuid, a DCE compatible Universally Unique Identifier library for Lua %{luacompatver}
