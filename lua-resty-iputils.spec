...
%global luapkgname resty-iputils
...
License:        BSD
URL:            https://github.com/hamishforbes/lua-resty-iputils
...
Summary:        Utility functions for working with IP addresses in nginx-module-lua for Lua %{luacompatver}
