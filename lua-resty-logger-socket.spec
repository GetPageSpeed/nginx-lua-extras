...
%global luapkgname resty-logger-socket
...
License:        BSD
URL:            https://github.com/cloudflare/lua-resty-logger-socket
...
Summary:        Raw-socket-based Logger Library for NGINX (based on nginx-module-lua) for Lua %{luacompatver}
