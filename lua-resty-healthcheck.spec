...
%global luapkgname resty-healthcheck
...
License:        BSD
URL:            https://github.com/Kong/lua-resty-healthcheck
...
Summary:        Healthcheck library for nginx-module-lua to validate upstream service status for Lua %{luacompatver}
