...
%global luapkgname resty-ctxdump
...
Version:        0.1
Release:        3%{?dist}
Summary:        Stash and apply the old ngx.ctx for avoiding being destoried after NGINX internal redirect happens
Group:          Development/Libraries
License:        BSD
URL:            https://github.com/tokers/lua-resty-ctxdump
...
Summary:        Stash and apply the old ngx.ctx for avoiding being destoried after NGINX internal redirect happens for Lua %{luacompatver}
