...
%global luapkgname resty-fileinfo
...
License:        BSD
URL:            https://github.com/bungle/lua-resty-fileinfo
...
Summary:        LuaJIT FFI bindings to libmagic, magic number recognition library - tries to determine file types for Lua %{luacompatver}
