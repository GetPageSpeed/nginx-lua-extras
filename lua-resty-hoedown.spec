...
%global luapkgname resty-hoedown
...
License:        BSD
URL:            https://github.com/bungle/lua-resty-hoedown
...
Summary:        LuaJIT FFI bindings to Hoedown, a standards compliant, fast, secure markdown processing library in C for Lua %{luacompatver}
