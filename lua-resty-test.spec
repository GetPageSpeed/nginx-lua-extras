...
License:        BSD
URL:            https://github.com/iresty/lua-resty-test
...
Summary:        Lua test frame for nginx-module-lua based on nginx-module-lua for Lua %{luacompatver}
