...
%global luapkgname resty-dns-server
...
License:        BSD
URL:            https://github.com/vislee/lua-resty-dns-server
...
Summary:        Lua DNS server driver for nginx-module-lua for Lua %{luacompatver}
