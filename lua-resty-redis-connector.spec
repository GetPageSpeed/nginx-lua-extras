...
%global luapkgname resty-redis-connector
...
License:        BSD
URL:            https://github.com/ledgetech/lua-resty-redis-connector
...
Summary:        Connection utilities for lua-resty-redis for Lua %{luacompatver}
