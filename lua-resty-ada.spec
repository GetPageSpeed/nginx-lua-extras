...
License:        BSD
URL:            https://github.com/bungle/lua-resty-ada
...
Summary:        LuaJIT FFI bindings to Ada — WHATWG-compliant and fast URL parser for Lua %{luacompatver}
