...
%global luapkgname resty-websocket-proxy
...
License:        BSD
URL:            https://github.com/Kong/lua-resty-websocket-proxy
...
Summary:        Reverse-proxying of websocket frames for Lua %{luacompatver}
