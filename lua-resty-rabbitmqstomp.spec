...
%global luapkgname resty-rabbitmqstomp
...
Summary:        Opinionated Lua RabbitMQ client library for nginx-module-lua apps based on the cosocket API for Lua %{luacompatver}
