...
%global luapkgname resty-newrelic

%global gittag v0.01-6
...
Summary:        This Lua library is a luajit ffi-based wrapper around newrelic agent SDK for nginx-module-lua nginx module for Lua %{luacompatver}
