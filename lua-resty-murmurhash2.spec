...
%global luapkgname resty-murmurhash2
...
License:        BSD
URL:            https://github.com/bungle/lua-resty-murmurhash2
...
Summary:        LuaJIT MurmurHash 2 bindings to NGINX / nginx-module-lua murmurhash2 implementation for Lua %{luacompatver}
