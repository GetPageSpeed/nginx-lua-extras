...
Version:        0.1
Release:        4%{?dist}
Summary:        Lua nsq client driver for nginx-module-lua based on the cosocket API
Group:          Development/Libraries
License:        BSD
URL:            https://github.com/rainingmaster/lua-resty-nsq
...
Summary:        Lua nsq client driver for nginx-module-lua based on the cosocket API for Lua %{luacompatver}
