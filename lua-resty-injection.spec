...
%global luapkgname resty-injection
...
License:        BSD
URL:            https://github.com/bungle/lua-resty-injection
...
Summary:        LuaJIT FFI bindings to libinjection (https://github.com/client9/libinjection) for Lua %{luacompatver}
